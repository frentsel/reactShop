...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LayoutJsx = __webpack_require__(270);

	var _LayoutJsx2 = _interopRequireDefault(_LayoutJsx);

	var _DeliveryJsx = __webpack_require__(275);

	var _DeliveryJsx2 = _interopRequireDefault(_DeliveryJsx);

	var _ContactJsx = __webpack_require__(276);

	var _ContactJsx2 = _interopRequireDefault(_ContactJsx);

	var _CartPageJsx = __webpack_require__(277);

	var _CartPageJsx2 = _interopRequireDefault(_CartPageJsx);

	var _ProductJsx = __webpack_require__(279);

	var _ProductJsx2 = _interopRequireDefault(_ProductJsx);

	var _ProductsJsx = __webpack_require__(281);
	...
	var _NotFoundJsx = __webpack_require__(284);

	var _NotFoundJsx2 = _interopRequireDefault(_NotFoundJsx);
	...
	_reactDom2['default'].render(_react2['default'].createElement(
	    ...
	    _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_reactRouter.Route, { path: '*', component: _NotFoundJsx2['default'] })
	        )
	    )
	...
	var ReactMount = {
	  ...
	  findComponentRoot: function findComponentRoot(ancestorNode, targetID) {
	    ...
	    firstChildren.length = 0;
	     ...
	     true ? (development) !== 'production' ? invariant(false, 'findComponentRoot(..., %s): Unable to find element. This probably ' + 'means the DOM was unexpectedly mutated (e.g., by the browser), ' + 'usually due to forgetting a <tbody> when using tables, nesting tags ' + 'like <form>, <p>, or <a>, or using non-SVG elements in an <svg> ' + 'parent. ' + 'Try inspecting the child nodes of the element with React ID `%s`.', targetID, ReactMount.getID(ancestorNode)) : invariant(false) : undefined;
	  },
	...
	function instantiateReactComponent(node) {
	  ...
	  if (node === null || node === false) {
	    ...
	    instance = ReactNativeComponent.createInstanceForText(node);
	     ...
	     true ? (development) !== 'production' ? invariant(false, 'Encountered invalid React node of type %s', typeof node) : invariant(false) : undefined;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function findDOMNode(componentOrElement) {
	  ...
	  !(componentOrElement.render == null || typeof componentOrElement.render !== 'function') ? (development) !== 'production' ? invariant(false, 'findDOMNode was called on an unmounted component.') : invariant(false) : undefined;
	   true ? (development) !== 'production' ? invariant(false, 'Element appears to be neither ReactComponent nor DOMNode (keys: %s)', Object.keys(componentOrElement)) : invariant(false) : undefined;
	}
	  ...
	  if (Array.isArray(children)) {
	    ...
	    if (iteratorFn) {
	      ...
	      var childrenString = String(children);
	       true ? (development) !== 'production' ? invariant(false, 'Objects are not valid as a React child (found: %s).%s', childrenString === '[object Object]' ? 'object with keys {' + Object.keys(children).join(', ') + '}' : childrenString, addendum) : invariant(false) : undefined;
	    }
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexRedirect = _react2['default'].createClass({
	  ...
	  /* istanbul ignore next: sanity check */
	  render: function render() {
	     true ? (development) !== 'production' ? (0, _invariant2['default'])(false, '<IndexRedirect> elements are for router configuration only and should not be rendered') : (0, _invariant2['default'])(false) : void 0;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Redirect = _react2['default'].createClass({
	  ...
	  /* istanbul ignore next: sanity check */
	  render: function render() {
	     true ? (development) !== 'production' ? (0, _invariant2['default'])(false, '<Redirect> elements are for router configuration only and should not be rendered') : (0, _invariant2['default'])(false) : void 0;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexRoute = _react2['default'].createClass({
	  ...
	  /* istanbul ignore next: sanity check */
	  render: function render() {
	     true ? (development) !== 'production' ? (0, _invariant2['default'])(false, '<IndexRoute> elements are for router configuration only and should not be rendered') : (0, _invariant2['default'])(false) : void 0;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Route = _react2['default'].createClass({
	  ...
	  /* istanbul ignore next: sanity check */
	  render: function render() {
	     true ? (development) !== 'production' ? (0, _invariant2['default'])(false, '<Route> elements are for router configuration only and should not be rendered') : (0, _invariant2['default'])(false) : void 0;
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _products = __webpack_require__(268);

	var _products2 = _interopRequireDefault(_products);

	var _purchases = __webpack_require__(269);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationJsx = __webpack_require__(271);

	var _NavigationJsx2 = _interopRequireDefault(_NavigationJsx);

	var _SortJsx = __webpack_require__(272);

	var _SortJsx2 = _interopRequireDefault(_SortJsx);

	var _SearchJsx = __webpack_require__(273);

	var _SearchJsx2 = _interopRequireDefault(_SearchJsx);

	var _CartJsx = __webpack_require__(274);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _httpJs = __webpack_require__(280);
	...
	var Product = _react2['default'].createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        $(".quick_view").fancybox({
	            ...
	            beforeMove: function beforeMove(instance) {
	    ...
	    render: function render() {
	        ...
	        var phone = this.state.phone,
	            ...
	            thumbnails = phone.images.map(function (img, num) {
	            return _react2['default'].createElement(
	                'a',
	                { key: num.toString(), 'data-fancybox': 'gallery', className: 'fancybox thumbnail', href: 'http://angular.github.io/angular-phonecat/step-13/app/img/phones/' + img },
	                _react2['default'].createElement('img', { src: 'http://angular.github.io/angular-phonecat/step-13/app/img/phones/' + img })
	            );
	        }),
	            gallery = phone.images.map(function (img, num) {
	            return _react2['default'].createElement(
	                'a',
	                { key: num.toString(), className: 'quick_view', 'data-fancybox': 'qw1', href: 'http://angular.github.io/angular-phonecat/step-13/app/img/phones/' + img },
	                '#'
	            );
	        });
	        ...
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'a',
	                        { href: img, className: 'quick_view', 'data-fancybox': 'qw1', 'data-qw-form': 'qw-form-1' },
	                        _react2['default'].createElement('img', { src: img, alt: phone.name })
	                    )
	                ),
	                _react2['default'].createElement(
	                    'div',
	                            ...
	                            _react2['default'].createElement(
	                                ...
	                                _react2['default'].createElement(
	                                    ...
	                                    _react2['default'].createElement(
	                                        ...
	                                        null,
	                                        'Qtt:',
	                                        _react2['default'].createElement('input', { type: 'number', className: 'product-quantity', value: '1', readOnly: 'readOnly' })
	                                    )
	                                ),
	                                _react2['default'].createElement(
	                                    'td',
	        ...
	        var list = products.map(function (phone, index) {
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement('img', { src: '../images/' + phone.imageUrl, alt: phone.name })
	                ),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'price' },
